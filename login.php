...
<html>
    ...
    <body>
        <div id="logo">
            <img src = "Images/logosig.jpg" id = "logoim" />
        </div>
		
        <main class="login">
        <section class="main">
            <h5>Per continuare, accedi a Helpineer.</h5>
            <?php
            ...
            <div class="signup-btn-container"><a class="signup-btn" href="signup.php">ISCRIVITI A HELPINEER</a></div>
        </section>
        </main> 
    </body>
</html>