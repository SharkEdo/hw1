<?php 
    ...
    ********************************************************/
    ...
    $next = isset($_GET['from']) ? 'AND C.id < '.mysqli_real_escape_string($conn, $_GET['from']).' ' : '';
        ...
        $query = "SELECT user AS userid, id AS CommandID, content AS content from C where user = $userid ORDER BY CommandID DESC LIMIT 10";
